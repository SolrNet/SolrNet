...
{
    public abstract class AbstractSolrQueryExecuter
    {
        ...
        protected AbstractSolrQueryExecuter(ISolrQuerySerializer querySerializer, ISolrFacetQuerySerializer facetQuerySerializer)
        {
