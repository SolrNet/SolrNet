...
{
    /// <summary>
    /// By default, the ranges used to compute range faceting between facet.range.start and facet.range.end are all inclusive of both endpoints, 
    /// while the the "before" and "after" ranges are not inclusive. This behavior can be modified by the facet.range.include param, which can be any combination of the following options...
    /// </summary>
