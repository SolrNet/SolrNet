...
namespace StructureMap.SolrNetIntegration.Tests {
    ...
    public class StructureMapIntegrationFixture {
        ...
        public StructureMapIntegrationFixture(ITestOutputHelper testOutputHelper)
        {
            ...
            {
                new SolrServer ("entity","http://solr:8983/solr/collection1", "StructureMap.SolrNetIntegration.Tests.Entity, StructureMap.SolrNetIntegration.Tests"),
                new SolrServer ("entity2","http://solr:8983/solr/core0", "StructureMap.SolrNetIntegration.Tests.Entity2, StructureMap.SolrNetIntegration.Tests"),
                new SolrServer ("entity3","http://solr:8983/solr/core1", "StructureMap.SolrNetIntegration.Tests.Entity2, StructureMap.SolrNetIntegration.Tests")
            };
