...
namespace SolrNet
{
    public static class ServiceCollectionExtensions
    {
            ...
            Func<IServiceProvider, string> urlRetriever, Action<SolrNetOptions> setupAction)
        {
            ...
            services.AddTransient(typeof(IValidationRule), typeof(MappedPropertiesIsInSolrSchemaRule));
            services.AddTransient(typeof(IValidationRule), typeof(RequiredFieldsAreMappedRule));
            services.AddTransient(typeof(IValidationRule), typeof(UniqueKeyMatchesMappingRule));
            services.AddTransient(typeof(IValidationRule), typeof(MultivaluedMappedToCollectionRule));
