...
namespace SolrNet.Tests.Integration {
    ...
    public class IntegrationFixture
    {
        ...
        private static readonly SolrNet.Tests.Utils.Lazy<object> init = new SolrNet.Tests.Utils.Lazy<object>(() => {
            Startup.Init<Product>(new LoggingConnection(new SolrConnection(serverURL)));
            return null;
        });
        private static readonly SolrNet.Tests.Utils.Lazy<object> initDict = new SolrNet.Tests.Utils.Lazy<object>(() => {
        ...
        private static readonly SolrNet.Tests.Utils.Lazy<object> initLoose = new SolrNet.Tests.Utils.Lazy<object>(() => {
